...
import contact_phone from "../images/contact/contact_phone.jpg"
  ...
  return (
    <div>
              ...
              <div className="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block opacity-0">
                <div className="search-bar row bg-light p-2 my-2 rounded-4">
                  <div className="col-md-4 d-none d-md-block">
                    {/* <select class="border-0 bg-transparent opacity-0"> */}
                    {/* <select class="form-select border-0 bg-transparent opacity-0"> */}
        ...
        <div className="container-fluid mx-0 mb-3">
          {/* <img src="https://source.unsplash.com/1200x400/?phone,contact" class="d-block w-100 my-2" alt=""> */}
          <img src={contact_phone} className="d-block w-100 my-2" alt="" />
          {/* <h2 class="contact" style="font-size:80px;color:black;position:absolute;top:41vh;left:38vw;">contact us</h2> */}
        </div>
        <div className="container">
          <h1 className="text-center">Contact us</h1>
          <form className="my-4" method="post" action="/contact">
            ...
            <div className="form-group my-4">
              <label htmlFor="desc">Tell me what you want to cantact me for.....</label>
              <textarea className="form-control" id="desc" name="desc" rows={3} placeholder="Describe your problem" defaultValue={""} />
            </div>
